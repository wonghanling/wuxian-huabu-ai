...
const CARDS: { key: string; title: string; desc: string; note?: string; image?: string; video?: string; aspect?: string; workflow?: string | string[]; audios?: { label: string; src: string }[] }[] = [
  {
    ...
    image: 'https://filmavo.blob.core.windows.net/assets/images/5f4604d9-8f1e-43c4-9ca2-dc994ca08848/1779675071210-crb634hpttj.jpg',
    aspect: '16/9',
    workflow: 'https://filmavo.blob.core.windows.net/assets/images/20ce33c8-6a71-41a1-804e-4997b4d95476/1783649211596-zq4lqg589z.jpg',
  },
  {
    key: 'card-2',
    title: '真人过审设定图',
    ...
    image: 'https://filmavo.blob.core.windows.net/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783580645778.jpg',
    aspect: '16/9',
    workflow: 'https://filmavo.blob.core.windows.net/assets/images/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783651713030-tvdhe5cr0of.jpg',
  },
  {
    key: 'card-3',
    title: '时空镜头调整',
    desc: '镜头前后穿梭并且可控制摄像机位',
    image: 'https://filmavo.blob.core.windows.net/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783658185613.jpg',
    workflow: 'https://filmavo.blob.core.windows.net/assets/images/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783658509346-kjx0xq784p.jpg',
  },
  {
    key: 'card-4',
    title: 'step2 生成多宫格提示词',
    desc: '一键根据多图生成专业的多宫格电影广告生成词',
    image: 'https://filmavo.blob.core.windows.net/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783660122809.jpg',
    workflow: [
      'https://filmavo.blob.core.windows.net/assets/images/kendeji2.png',
      'https://filmavo.blob.core.windows.net/assets/images/kendeji3.png',
      'https://filmavo.blob.core.windows.net/assets/images/kendeji4.png',
      'https://filmavo.blob.core.windows.net/assets/images/kendeji5.png',
    ],
  },
  {
    key: 'card-5',
    ...
    aspect: '16/9',
    workflow: [
      'https://filmavo.blob.core.windows.net/assets/images/shouwei1.png',
      'https://filmavo.blob.core.windows.net/assets/images/shouwei2.png',
      'https://filmavo.blob.core.windows.net/assets/images/shouwei3.png',
      'https://filmavo.blob.core.windows.net/assets/images/shouwei4.png',
    ],
  },
  {
    key: 'card-6',
    ...
    aspect: '16/9',
    workflow: [
      'https://filmavo.blob.core.windows.net/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1781869076179.jpg',
      'https://filmavo.blob.core.windows.net/assets/images/Step4-4.png',
      'https://filmavo.blob.core.windows.net/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1781873096752.jpg',
    ],
  },
  {
    key: 'card-7',
    ...
    image: 'https://filmavo.blob.core.windows.net/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783667137447.jpg',
    aspect: '16/9',
    workflow: [
      'https://filmavo.blob.core.windows.net/assets/images/yuyin1.png',
      'https://filmavo.blob.core.windows.net/assets/images/yuyin2.png',
      'https://filmavo.blob.core.windows.net/assets/images/yuyin3.png',
      'https://filmavo.blob.core.windows.net/assets/images/yuyin4.png',
      'https://filmavo.blob.core.windows.net/assets/images/yuyin5.png',
    ],
    audios: [
      { label: '战斗机作战场景音效', src: 'https://filmavo.blob.core.windows.net/assets/audio/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783666568825-3gecbsfa6kx.mp3' },
    ],
  },
  {
    key: 'card-8',
    ...
    image: 'https://filmavo.blob.core.windows.net/assets/images/3Ddaoyantai.png',
    aspect: '16/9',
  },
];
