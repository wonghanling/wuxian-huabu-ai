...
const CARDS: { key: string; title: string; desc: string; image?: string; video?: string; aspect?: string; workflow?: string | string[]; audios?: { label: string; src: string }[] }[] = [
  {
    ...
    image: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/5f4604d9-8f1e-43c4-9ca2-dc994ca08848/1779675071210-crb634hpttj.jpg?width=1200&quality=75',
    aspect: '16/9',
    workflow: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/20ce33c8-6a71-41a1-804e-4997b4d95476/1783649211596-zq4lqg589z.jpg?width=1200&quality=75',
  },
  {
    key: 'card-2',
    title: 'seedance 真人过审设定图',
    desc: '一键生成过审合规人物角色图',
    image: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783580645778.jpg?width=1200&quality=75',
    aspect: '16/9',
    workflow: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783651713030-tvdhe5cr0of.jpg?width=1200&quality=75',
  },
  {
    key: 'card-3',
    title: '时空镜头调整',
    desc: '镜头前后穿梭并且可控制摄像机位',
    image: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783658185613.jpg?width=1200&quality=75',
    workflow: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783658509346-kjx0xq784p.jpg?width=1200&quality=75',
  },
  {
    key: 'card-4',
    title: '智能多宫格分镜生成词',
    desc: '一键根据多图生成专业的多宫格电影广告生成词',
    image: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783660122809.jpg?width=1200&quality=75',
    workflow: [
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/kendeji2.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/kendeji3.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/kendeji4.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/kendeji5.png?width=1200&quality=75',
    ],
  },
  {
    key: 'card-5',
    ...
    aspect: '16/9',
    workflow: [
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/shouwei1.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/shouwei2.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/shouwei3.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/shouwei4.png?width=1200&quality=75',
    ],
  },
  {
    key: 'card-6',
    ...
    aspect: '16/9',
    workflow: [
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1781869076179.jpg?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/Step4-4.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1781873096752.jpg?width=1200&quality=75',
    ],
  },
  {
    key: 'card-7',
    ...
    image: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783667137447.jpg?width=1200&quality=75',
    aspect: '16/9',
    workflow: [
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/yuyin1.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/yuyin2.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/yuyin3.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/yuyin4.png?width=1200&quality=75',
      'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/yuyin5.png?width=1200&quality=75',
    ],
    audios: [
  ...
  },
  {
    ...
    image: 'https://qvcantdhbsulcucufwtp.supabase.co/storage/v1/render/image/public/assets/images/3D.png?width=1200&quality=75',
    aspect: '16/9',
  },
];
