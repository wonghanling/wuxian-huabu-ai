    ...
    <div className="w-full h-full flex flex-col p-6 md:p-8">
      ...
      >
        ...
        >
          ...
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://filmavo.blob.core.windows.net/assets/images/59bde757-0c1f-49ef-b078-6b3ea6a5ac91/1783927049206-a9wnw3qwuqu.jpg" alt="涂鸦标注演示" className="w-full h-auto block" draggable={false} loading="lazy" />
            {/* 落定后右上角完成勾 */}
            <div
