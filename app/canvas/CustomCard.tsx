  ...
  */
  ...
  component(shape: CustomCardShape) {
    ...
    const VIDEO_MODEL_CONFIG: Record<string, {
      ...
      'veo3.1-first-last': { mode: 'firstLastFrame',durations: [4,6,8], resolutions: ['720p','1080p','4k'],    aspectRatios: ['16:9','9:16'],        supportsAudio: false, audioBuiltIn: false, supportsEndFrame: true,  defaultResolution: '720p' },
