        ...
        >
          <button
            onClick={(e) => {
              ...
              editor.updateShape({ id: shape.id, type: 'seedance-card' as any, props: { ...shape.props, isMinimized: newMinimized, w: newMinimized ? 150 : 280, h: newMinimized ? 80 : 420 } });
            }}
            onPointerDown={(e) => e.stopPropagation()}
          ...
          {isMinimized ? (
            ...
            <div className="relative h-full">
              ...
              {/* 主内容区 - 单列滚动 */}
              <div ref={scrollContainerRef} className="p-4 flex flex-col h-full overflow-y-auto">
            ...
            {generatedVideo && showVideoOutput && (
              ...
              >
                ...
                {capturedFrame && (
                  <div className="bg-black/40 border-t border-purple-500/30">
