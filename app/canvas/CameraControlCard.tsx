  ...
  component(shape: CameraControlCardShape) {
    ...
    return (
      <HTMLContainer style={{ width: w, height: h, pointerEvents: 'all', overflow: 'visible' }}>
        ...
        {lightbox && generatedImage && (
          ...
          >
            <div className="relative" style={{ maxWidth: '80vw', maxHeight: '80vh' }} onClick={(e) => e.stopPropagation()}>
              <img src={generatedImage} alt="" className="rounded-xl object-contain" style={{ maxWidth: '80vw', maxHeight: '80vh', imageRendering: '-webkit-optimize-contrast', transform: 'translateZ(0)' }} />
              <button
        ...
        <div className="w-full bg-zinc-900/95 backdrop-blur-sm border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
          {/* 标题栏 */}
