...
输出要求:
- 中文,像专业 Character Bible(角色圣经)那样的自然语言
- 每个角色单独成段,用「角色N:姓名」起头
- 涵盖故事功能、视觉设计、心理、象征、AI 一致性规则
- 视觉描述要具体可重复生成,便于后续生成角色形象图
- 不要改写故事、不要创造不必要角色、不要输出 JSON、不要额外解释`,
...
输出要求:
- 中文,像专业 Production Bible(美术圣经)那样的自然语言
- 每个场景单独成段,用「场景N:名称」起头
- 涵盖故事/主题/情绪功能、世界观、视觉设计、灯光、AI 一致性规则
- 视觉描述要具体可重复生成,便于后续生成场景概念图
- 不要改写故事、不要输出 JSON、不要额外解释`,
...
输出要求:
- 中文,像专业 Prop Bible(道具圣经)那样的自然语言
- 每个道具单独成段,用「道具N:名称」起头
- 涵盖故事/主题/情绪功能、视觉设计、象征、AI 一致性规则
- 视觉描述要具体可重复生成,便于后续生成道具设计图
- 不要改写故事、不要输出 JSON、不要额外解释`,
