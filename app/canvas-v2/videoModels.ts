...
export const VIDEO_MODELS: VideoModel[] = [
  ...
  { id: 'wan3.0-t2v', label: 'Wan 3.0 文生', mode: 't2v', durations: [2, 3, 4, 5, 6, 8, 10, 12, 15, 20, 25, 30], aspectRatios: ['adaptive','16:9','9:16','1:1','4:3','3:4'], resolutions: ['480P','720P','1080P'], defaultResolution: '1080P', supportsAudio: true, price: '480P ¥0.30/720P ¥0.63/1080P ¥1.17 每秒' },
  ...
  { id: 'wan3.0-prime-t2v', label: 'Wan 3.0 高速 文生', mode: 't2v', durations: [2, 3, 4, 5, 6, 8, 10, 12, 15, 20, 25, 30], aspectRatios: ['adaptive','16:9','9:16','1:1','4:3','3:4'], resolutions: ['480P','720P','1080P'], defaultResolution: '1080P', supportsAudio: true, price: '480P ¥0.50/720P ¥0.95/1080P ¥1.80 每秒' },
