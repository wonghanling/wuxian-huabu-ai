...
Maintain strong visual consistency in every panel.`,
  ...
  },
  {
    label: '真人设定',
    accent: 'gray',
    prompt: `对角色设定图中的每一个人脸格子进行隐私遮挡。遮挡规则：每个格子只遮挡一个器官，相邻格子交替——奇数格遮眼睛区域（保留嘴），偶数格遮嘴巴区域（保留眼睛）。目的是确保所有格子合并后无法还原出完整人脸。保持原图构图、衣服、发型、背景、网格线不变。只添加纯黑色矩形遮挡条覆盖指定器官，不改变人物身份、姿态和画面风格。`,
  },
];
